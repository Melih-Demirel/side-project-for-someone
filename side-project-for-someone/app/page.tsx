...
const sections = [
  ...
  },
  {
    ...
    subsections: [
      ...
      { title: "Welke aanpak is mogelijk?", content: "Een belangrijke stap is het herkennen van perfectionistische denkpatronen. Door middel van cognitieve gedragstherapie kunnen jongeren leren om hun overtuigingen te bevragen en meer realistische normen voor zichzelf te ontwikkelen. Zelfcompassie is hierbij een belangrijk element: leren mild te zijn voor zichzelf, fouten toe te laten als onderdeel van het leerproces, en zichzelf te waarderen los van prestaties. Daarnaast is het nuttig om doelen op te splitsen in haalbare stappen, en regelmatig stil te staan bij wat goed ging. Het bijhouden van een successen- of groeidagboek kan dit proces ondersteunen." },
